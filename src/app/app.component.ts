               ...
               <div class="container">
                 ...
                 <ng-template #myPanel let-item let-index="index">
                   <div style="color: red; padding: 10px;">
                     <h4>Texte présenté numéro {{index}}</h4>
                     <span>{{item}}</span>
                     <hr>
                   </div>
                 </ng-template>
...
export class AppComponent {
  @ViewChild('myPanel', {read: TemplateRef}) panelTemplateRef;
  ...
  constructor() {
    this.texts = this.textsBase;
    this.texts.push(...this.textsBase);
    this.allTexts = this.texts.join(' ');
  }
}
